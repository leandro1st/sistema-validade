...
if ($numero_pesquisa > 0){
    ...
    $add_exclusao = mysqli_query($connect, "INSERT INTO $excluidos(nome_produto, validade, hora_exclusao, id) VALUES('$vetor_nome_produto', '$vetor_validade', '$hora_exclusao', '$vetor_id')");
} else{
    ?>
        <script>
